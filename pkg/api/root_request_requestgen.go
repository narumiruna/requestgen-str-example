// Code generated by "requestgen -method GET -url / -type RootRequest -responseType RootResponse"; DO NOT EDIT.
...
func (r *RootRequest) applySlugsToUrl(url string, slugs map[string]string) string {
...
func (r *RootRequest) iterateSlice(slice interface{}, _f func(it interface{})) {
...
func (r *RootRequest) isVarSlice(_v interface{}) bool {
